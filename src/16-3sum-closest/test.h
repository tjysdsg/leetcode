...
TEST(test, 0) {
    ...
    EXPECT_EQ(sol.threeSumClosest(v, -2), -2);
}

TEST(test, 1) {
    SOLUTION_CLASS sol;
    vector<int> v{-1, 2, 1, -4};
    EXPECT_EQ(sol.threeSumClosest(v, 1), 2);
}

TEST(test, 2) {
    SOLUTION_CLASS sol;
    vector<int> v{0, 0, 0};
    EXPECT_EQ(sol.threeSumClosest(v, 1), 0);
}

TEST(test, 3) {
    SOLUTION_CLASS sol;
    vector<int> v{321, 413, 82, 812, -646, -858, 729, 609, -339, 483, -323, -399, -82, -455, 18, 661, 890, -328, -311,
    ...
    EXPECT_EQ(sol.threeSumClosest(v, 2218), 2218);
}
